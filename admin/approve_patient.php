...
if(isset($_GET['approve'])){
    ...
    header("location:approve_patient.php");
    exit;
}

$patients = mysqli_query($conn,"SELECT * FROM users WHERE role='patient' AND status='pending'");
$num_pending = mysqli_num_rows($patients);
?>
...
<head>
    ...
    <title>Approve Patients | Admin Panel</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="#"><i class="fa-solid fa-user-check"></i> Approve Patients</a>
    ...
    <div class="main">
        ...
        <div class="header-box">
            <div>
                ...
                <p>Review and approve new patient registrations.</p>
            </div>
            <div>
                <span class="badge-pending">
                    <i class="fa-solid fa-clock me-1"></i> <?= $num_pending ?> Pending
                </span>
            </div>
        </div>
        ...
        <div class="table-card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="user-info">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">Registered recently</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-end align-middle">
                                    <a class="btn-approve" href="?approve=<?= $p['id'] ?>">
            ...
            <?php } else { ?>
                ...
                <div class="empty-state">
                    ...
                    <h4>All Caught Up!</h4>
                    <p>There are no pending patient approvals at the moment.</p>
                </div>
